...
Vector.prototype = {
  ...
  decrease: function decrease(vec) {
  ...
  relative: function relative(vec) {
    var x = vec.x - this.x;
    var y = vec.y - this.y;
    return new Vector(x, y);
  },
  negativeX: function negativeX() {
    this.x *= -1;
    return this;
  },
  negativeY: function negativeY() {
    this.y *= -1;
    return this;
  },
...
function randomColor() {
  return "#".concat(Math.random().toString(16).substr(2, 6));
}
...
function () {
  function Body(params) {
    ...
    lodash.map(Object.keys(extendedOpts), function (key) {
      _this[key] = extendedOpts[key];
    });
  }
...
function () {
  ...
  _createClass(Ticker, [{
    ...
    key: "setUpdateFunc",
    value: function setUpdateFunc(cb) {
      this.updateFunc = cb;
    }
  }]);
...
function () {
  ...
  _createClass(Render, [{
    key: "draw",
    value: function draw(x, y, deg, drawFunction) {
      this.ctx.save();
...
function () {
  ...
  _createClass(Game2d, [{
    ...
    key: "removeBody",
    value: function removeBody(id) {
      var index = lodash.findIndex(this.objects, function (item) {
        return item.id === id;
      });
...
/*#__PURE__*/
function (_Body) {
  _inherits(Shape, _Body);

  function Shape(params) {
    _classCallCheck(this, Shape);

    return _possibleConstructorReturn(this, _getPrototypeOf(Shape).call(this, params));
  }
